...
public class HistoryOperationStructureTest extends TestBase {
    ...
    public void init() {
        ...
        instance = new HistoryOperation(null,mes, new ProjectBeanMock(), new MaterialNameBean(), new MaterialIndexBean(), strucInfo, new StorageInformationBuilder(MessagePresenterMock.getInstance(), materialService), null, new ArrayList<>(), null);
    }
