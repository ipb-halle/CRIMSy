...
public class ContainerSearchMaskBeanMock extends ContainerSearchMaskBean {
    ...
    public ContainerSearchMaskBeanMock setContainerService(ContainerService service) {
        this.containerService = service;
        return this;
    }

    public ContainerSearchMaskBeanMock setProjectService(ProjectService service) {
