...
public class LdapObject {
     ...
     */
    public LdapObject addMembership(String dn) { this.membership.add(dn);  return this; }
    ...
    /**
     * @return list of MEMBER_OF distinguished names. In contrast to 
     * LBAC membership semantics, this list will never contain references 
     * to itself.
     */
    public List<String> getMemberships() { return this.membership; }
    ...
    public LdapObject setDN(String s) { this.dn = s; return this; }
    public LdapObject setEmail(String s) { this.email = s; return this; }
    public LdapObject setId(UUID u) { this.id = u; return this; }
    public LdapObject setLogin(String s) { this.login = s; return this; }
    public LdapObject setName(String s) { this.name = s; return this; }
    public LdapObject setPhone(String s) { this.phone = s; return this; }
    public LdapObject setType(MemberType t) { this.type = t; return this; }
    public LdapObject setUniqueId(String s) { this.uniqueId = s; return this; }
}
