...
public class EntityGraph {
    ...
    /**
     * Graph names get assigned by EntityGraphBuilders and can 
     * be used to identify sub-graphs in an EntityGraph by walking 
     * the names of child entities.
    ...
    /**
     * Select a sub-graph from this EntityGraph matching the given
     * graphPath.
