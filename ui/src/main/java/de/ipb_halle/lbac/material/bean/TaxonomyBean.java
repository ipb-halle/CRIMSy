...
public class TaxonomyBean implements Serializable {
    ...
    public void reloadTreeNode() {
        try {
            ...
            Collections.sort(shownTaxonomies, (o1, o2) -> o1.getId() > o2.getId() ? 1 : -1);
            for (Taxonomy t : shownTaxonomies) {
                logger.info(t.getFirstName() + " -> " + t.getTaxHierachy().size());
            }
            ...
            for (Taxonomy t : shownTaxonomies) {
                if (!t.getTaxHierachy().isEmpty()) {
                    ...
                    logger.info("Parent of " + t.getFirstName() + " is " + parent);
    ...
    private boolean saveNewTaxonomy() {
        ...
        if (selectedTaxonomy != null) {
            ...
            Collections.sort(taxonomyToCreate.getTaxHierachy(), (o1, o2) -> o1.getId() > o2.getId() ? 1 : -1);
        }
