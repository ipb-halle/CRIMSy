 ...
 * @author fmauz
 */
public class OverviewHistoryController implements HistoryController<MaterialOverviewDifference> {

    private MaterialBean materialBean;

    public OverviewHistoryController(MaterialBean materialBean) {
