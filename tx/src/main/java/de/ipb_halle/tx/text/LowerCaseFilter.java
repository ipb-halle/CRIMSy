...
public class LowerCaseFilter extends AbstractFilter {
    ...
    public final static String FILTER_TYPE = "LowerCaseFilter";
     ...
     * constructor
     */
    public LowerCaseFilter(JsonObject config) {
        super(config);
    ...
    public FilterState filter(FilterOperation op) {
        while(true) {
            ...
            this.textRecord.setText(this.textRecord.getText().toLowerCase());
        }
    }
