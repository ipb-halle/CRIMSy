...
/**
 * Extended Default parser.
 * @since 1.3
 */
public class ExtendedDefaultParser implements CommandLineParser
{
    ...
    protected List<Options> expectedOpts;
            ...
            throws ParseException
    {
        ...
        List<Options> l = options.getRequiredOptions(); // direct assignment would not allow SuppressWarnings annotation
        expectedOpts = new ArrayList<Options>(l);
