...
public class TermFrequencyList {
    ...
    /**
     * constructor for SQL mapped results (@see TermVectorEntity)
     * @param tf list of TermFrequency objects in descending order
     */
    public TermFrequencyList(List<TermFrequency> tf) {
        termFreq = tf;
    }
    ...
    public String getStemmedWordFor(String d) {
        for (StemmedWordOrigin swo : unstemmedWords) {
            if (swo.getOriginalWord().equals(d)) {
